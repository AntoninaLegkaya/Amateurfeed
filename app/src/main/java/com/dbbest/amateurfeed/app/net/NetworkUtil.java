    ...
    public static <T> ResponseWrapper<T> handleError(Exception e) {
        if (e != null) {
            if (e instanceof SocketTimeoutException) {
                ...
                return new ResponseWrapper<>(CODE_UNABLE_TO_RESOLVE_HOST, false, "Unable to resolve host", null);
            }
        }
        return new ResponseWrapper<>(CODE_UNKNOWN_IO_EXCEPTION, false, "An unknown exception happened ¯\\_(ツ)_/¯", null);
    }
}

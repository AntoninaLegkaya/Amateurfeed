...
public class CommandResultReceiver extends StackedResultReceiver<CommandResultReceiver.CommandListener> {
    ...
    @Override
    protected void onHandleResult(@NonNull CommandListener listener, int resultCode, Bundle resultData) {

...
public class TestDb extends AndroidTestCase {
  ...
  public void testCreateDb() throws Throwable {
    ...
    tableNameHashSet.add(PreviewEntry.TABLE_NAME);
    tableNameHashSet.add(CommentEntry.TABLE_NAME);
    tableNameHashSet.add(TagEntry.TABLE_NAME);
    tableNameHashSet.add(UserProfileEntry.TABLE_NAME);
    tableNameHashSet.add(UserNewsEntry.TABLE_NAME);
    ...
    c = db.rawQuery("PRAGMA table_info(" + PreviewEntry.TABLE_NAME + ")",
        null);
    ...
    previewColumnHashSet.add(PreviewEntry._ID);
    previewColumnHashSet.add(PreviewEntry.COLUMN_TITLE);
    previewColumnHashSet.add(PreviewEntry.COLUMN_TEXT);
    previewColumnHashSet.add(PreviewEntry.COLUMN_LIKES);
    previewColumnHashSet.add(PreviewEntry.COLUMN_IS_LIKE);
    previewColumnHashSet.add(PreviewEntry.COLUMN_AUTHOR);
    previewColumnHashSet.add(PreviewEntry.COLUMN_AUTHOR_IMAGE);
    previewColumnHashSet.add(PreviewEntry.COLUMN_CREATE_DATE);
    previewColumnHashSet.add(PreviewEntry.COLUMN_IMAGE);
    previewColumnHashSet.add(PreviewEntry.COLUMN_IS_MY);
  ...
  public void testPreviewTable() {
    ...
    long previewRowId = db.insert(PreviewEntry.TABLE_NAME, null, previewValues);
    assertTrue(previewRowId != -1);

    // Fourth Step: Query the database and receive a Cursor back
    // A cursor is your primary interface to the query results.
    Cursor previewCursor = db.query(
        PreviewEntry.TABLE_NAME,  // Table to Query

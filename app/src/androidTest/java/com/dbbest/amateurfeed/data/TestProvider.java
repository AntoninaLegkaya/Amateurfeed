...
public class TestProvider extends AndroidTestCase {
  ...
  public void testGetType() {
    ...
    String type = mContext.getContentResolver().getType(PreviewEntry.CONTENT_URI);
    ...
    assertEquals("Error: the PreviewEntry CONTENT_URI should return PreviewEntry.CONTENT_TYPE",
        PreviewEntry.CONTENT_TYPE, type);
  ...
  public void testBasicTagQuery() {
    ...
    long tagRowId = db.insert(TagEntry.TABLE_NAME, null, tagValues);
  ...
  public void testInsertReadProvider() {
    ...
    mContext.getContentResolver().registerContentObserver(PreviewEntry.CONTENT_URI, true, tco);
    Uri previewUri = mContext.getContentResolver().insert(PreviewEntry.CONTENT_URI, previewValues);
    ...
    mContext.getContentResolver().registerContentObserver(TagEntry.CONTENT_URI, true, tco);
    ...
    // A cursor is your primary interface to the query results.
    Cursor tagCursor = mContext.getContentResolver().query(
        TagEntry.CONTENT_URI,  // Table to Query
        null, // leaving "columns" null just returns all the columns.
        null, // cols for "where" clause
        null, // values for "where" clause
...
/** Test get Tag item by _ID**/
    ...
    Uri uriTagId = TagEntry.buildTagUriById(FeedProvider.TEST_TAG_ID);
...
/** Test get preview by Author**/
    ...
    Uri uriPreviewAuthor = PreviewEntry.buildPreviewUriByAuthor(FeedProvider.TEST_TAG_AUTHOR);
